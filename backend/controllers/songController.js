...
const getSongs = async (req,res) => {
    try {
        const response = await axios.get(
            `https://api.jamendo.com/v3.0/tracks/?client_id=c8a00373&format=jsonpretty&limit=15`
        );
...
const getPlaylistByTag = async(req,res) => {
    try {
        ...
        //fetched data need to be converted to json but with axios it is already conecrted to object data
