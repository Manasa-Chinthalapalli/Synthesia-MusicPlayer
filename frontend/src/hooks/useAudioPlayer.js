...
//play a song at a specific index value
    ...
    //Actually loading/playing the audio happens in the effect below, once
    //audioState.currentSong has actually updated. Doing it here (synchronously,
    //right after dispatch) used to load the *previous* song because the
    //<audio>/<source> element hadn't re-rendered with the new src yet.
};

    //Whenever the selected track changes, point the <audio> element at the
    //new source directly (this takes priority over any <source> children)
    //and start loading/playing it.
    useEffect(() => {
